<template>
    <nav class="nav">
        <div class="nav__menu-btn">
            <a href="#app"
                ><button class="nav__menu-btn__line" @click="showMenu()">
                    <span></span></button
            ></a>
        </div>
        <div class="nav__logo">
    ...
    <nav id="menu" class="menu closed">
        <div class="menu__wrapper">
            <div class="menu__wrapper__close">
                <button
                    class="menu__wrapper__close__button"
                    @click="showMenu()"
                >
            ...
            <div class="menu__wrapper__entries">
                ...
                <router-link to="/personnalisation">
                    <p class="menu__wrapper__entries__entry">
                        Personnalisation
                    </p>
                </router-link>
        ...
        showMenu() {
            ...
            if (menu.hasClass("closed")) {
                ...
                $("body").click((e) => {
                    ...
                    $(".menu__wrapper__entries__entry").click(() => {
